 ...
 * Size: 16 px
 * Bpp: 1
 * Opts: --bpp 1 --size 16 --font /home/holidin/SquareLine/assets/Roboto-Bold.ttf -o /home/holidin/SquareLine/assets/ui_font_volume.c --format lvgl -r 0x20-0x7f --no-compress --no-prefilter
 ******************************************************************************/

#include "../ui.h"

#ifndef UI_FONT_VOLUME
#define UI_FONT_VOLUME 1
#endif
...
#if LV_VERSION_CHECK(8, 0, 0)
const lv_font_t ui_font_volume = {
#else
lv_font_t ui_font_volume = {
#endif
