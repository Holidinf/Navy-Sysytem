 ...
 * Size: 20 px
 * Bpp: 1
 * Opts: --bpp 1 --size 20 --font /home/holidin/SquareLine/assets/Roboto-Bold.ttf -o /home/holidin/SquareLine/assets/ui_font_value.c --format lvgl -r 0x20-0x7f --no-compress --no-prefilter
 ******************************************************************************/

#include "../ui.h"

#ifndef UI_FONT_VALUE
#define UI_FONT_VALUE 1
#endif
...
#if LV_VERSION_CHECK(8, 0, 0)
const lv_font_t ui_font_value = {
#else
lv_font_t ui_font_value = {
#endif
