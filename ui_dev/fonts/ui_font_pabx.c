 ...
 * Size: 20 px
 * Bpp: 1
 * Opts: --bpp 1 --size 20 --font /home/holidin/SquareLine/assets/Roboto-Bold.ttf -o /home/holidin/SquareLine/assets/ui_font_pabx.c --format lvgl -r 0x20-0x7f --no-compress --no-prefilter
 ******************************************************************************/

#include "../ui.h"

#ifndef UI_FONT_PABX
#define UI_FONT_PABX 1
#endif
...
#if LV_VERSION_CHECK(8, 0, 0)
const lv_font_t ui_font_pabx = {
#else
lv_font_t ui_font_pabx = {
#endif
