...
// create thread for running client service
   ret = pthread_create(&tcp_client_handler, NULL, tcp_client_thread, NULL);
   if (ret < 0) {
       printf("Error: Failed to create TCP Client Thread\n");
   }
